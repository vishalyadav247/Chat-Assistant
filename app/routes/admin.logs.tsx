...
} from "../lib/admin/logs-report.server";
import {
  LEVEL_LABELS,
  LOG_RANGE_HOURS,
  RANGE_LABELS,
...
// Admin → Logs (spec 21). Every merchant's errors and warnings in one
// window. Cross-tenant aggregate BY DESIGN; guarded by requireAdminUser.
...
/** Operator console runs on UTC, matching the rest of /admin. */
...
export default function AdminLogs() {
  ...
  return (
    <AdminShell adminEmail={data.adminEmail}>
      <AdminPage heading="Logs" subheading="Errors and warnings from every merchant, newest first. Filter to a store when someone reports a problem. Rows are kept for 14 days — this is a diagnostic trail, not an audit log, and it never stores message bodies or contact details.">
        <s-stack gap="base">
          <TabPills
          ...
          <AdminCard heading="Top failing events">
