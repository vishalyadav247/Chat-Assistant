...
export default function AdminOverview() {
  ...
  return (
    <AdminShell adminEmail={data.adminEmail}>
      <AdminPage heading="Overview" subheading="Global state of ChatConvert across every installed store. Settings changed in this console apply to all merchants.">
        <s-stack gap="base">
          <StatGrid>
            <StatTile
          ...
          <AdminCard heading="Stores by plan">
            <s-stack gap="base">
          ...
          <AdminCard heading="Recent installs">
          ...
          <AdminCard heading="Jump to">
            <div style={{ display: "flex", gap: SPACE.sm, flexWrap: "wrap" }}>
              <Link to="/admin/usage">Token usage &amp; cost</Link>
              <Link to="/admin/ai">AI model settings</Link>
              <Link to="/admin/plans">Plans &amp; enforcement</Link>
