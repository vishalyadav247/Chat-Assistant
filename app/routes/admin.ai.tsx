...
// Admin → AI model settings (spec 19). Global overrides applied to every
...
export default function AdminAiSettings() {
  ...
  return (
    <AdminShell adminEmail={data.adminEmail}>
      <AdminPage heading="AI model settings" subheading="Applies to every store's chat pipeline. Changes take effect within about 30 seconds — no deploy or restart.">
        <s-stack gap="base">
          <AdminCard heading="Chat model">
            <s-stack gap="base">
          ...
          <AdminCard heading="Generation overrides">
            <s-stack gap="base">
              <s-text color="subdued">
          ...
          <AdminCard heading="Embedding model">
