...
const ROWS: Row[] = [
  ...
  { module: "Routing", feature: "No shop-domain entry anywhere (req 2.3.1)", spec: "17", surface: "Public", design: "Yes", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "J-10", verifiedBy: "compliance", result: "PASS", defects: "D-30", notes: "Req 2.3.1 verified on shopify.dev 2026-09-14 (QA-C1): form removed from /, /auth/login redirect-only; routing.test guards it." },
...
const DEFECTS: Defect[] = [
  ...
  { id: "D-30", severity: "Critical", area: "Compliance", file: "app/routes/_index/route.tsx", summary: "Landing page asked for a myshopify.com domain. App Store req 2.3.1 (verified on shopify.dev 2026-09-14) forbids manual entry of a shop domain; the 2026-09-07 reversal that restored the form was wrong. QA-C1: form removed, /auth/login redirect-only.", status: "Fixed", verifiedBy: "routing.test.ts" },
