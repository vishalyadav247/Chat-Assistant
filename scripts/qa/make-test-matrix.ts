...
const ROWS: Row[] = [
  ...
  { module: "Billing", feature: "Monthly-only billing", spec: "15", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "A-02,A-03", verifiedBy: "test-billing-mock.ts", result: "PASS", defects: "D-15", notes: "Annual billing removed 2026-09-07; a legacy yearly row still never bills (Shopify rejects usage lines on ANNUAL)." },
  ...
  { module: "Billing", feature: "Usage metering & overage", spec: "15", surface: "Server", design: "N/A", logic: "Yes", tenancy: "Yes", planGate: "Yes", cases: "A-17,A-18,A-22,A-23,A-24", verifiedBy: "overage.test.ts (47 checks)", result: "PASS", defects: "", notes: "30-min session rule; isTest never meters; overageCount vs overageReported is the billing debt, retried hourly; aiAllowed stops at the merchant approved cappedAmount so nothing is served unpaid." },
  ...
  { module: "Plans", feature: "Matrix matches published pricing", spec: "15", surface: "Server", design: "N/A", logic: "Yes", tenancy: "N/A", planGate: "Yes", cases: "B-01", verifiedBy: "admin-check.ts", result: "PASS", defects: "D-16", notes: "Reconciled 2026-08-21: manual_qas, policy_pages, crawl_pages, team_seats corrected." },
  { module: "Plans", feature: "Operator edits propagate to all shops", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "Yes", planGate: "Yes", cases: "B-02,B-03", verifiedBy: "admin-check.ts", result: "PASS", defects: "", notes: "In-process immediately; other processes within the 30s REFRESH_TTL_MS." },
  { module: "Plans", feature: "Enforcement switch (open/enforced)", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "N/A", planGate: "Yes", cases: "B-05", verifiedBy: "admin-check.ts, plan-gates.test.ts", result: "PASS", defects: "", notes: "Default flipped to 'enforced' 2026-08-21." },
  ...
  { module: "Plans", feature: "New seams: survey, push, custom recs", spec: "15", surface: "Server", design: "N/A", logic: "Yes", tenancy: "Yes", planGate: "Yes", cases: "B-15", verifiedBy: "plan-gates.test.ts", result: "PASS", defects: "", notes: "multi_language un-gated 2026-09-03 (every plan) — B-15 now asserts the save succeeds on Free." },
  { module: "Plans", feature: "Corrupt override row handling", spec: "19", surface: "Admin", design: "N/A", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "B-07", verifiedBy: "admin-check.ts", result: "PASS", defects: "D-12", notes: "" },

  { module: "Promo codes", feature: "Code normalization & validation", spec: "15", surface: "Admin/Admin", design: "Manual", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "C-10,C-18", verifiedBy: "promo-codes.test.ts", result: "PASS", defects: "D-02,D-18", notes: "Regex bug fixed; percent values >2dp now rejected." },
  ...
  { module: "Promo codes", feature: "Operator console (create/toggle/delete)", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "C-15", verifiedBy: "promo-codes.test.ts", result: "PASS", defects: "", notes: "Delete blocked for ever-redeemed codes." },
  ...
  { module: "AI pipeline", feature: "Admin AI overrides don't de-tune the router", spec: "19", surface: "Server", design: "N/A", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "D-05,D-06", verifiedBy: "model-portability.test.ts", result: "PASS", defects: "D-03", notes: "" },
  ...
  { module: "Routing", feature: "Admin routes (12)", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "Yes", planGate: "N/A", cases: "J-03,J-08", verifiedBy: "routing.test.ts", result: "PASS", defects: "D-37,D-29", notes: "Deep-link query preserved on auth bounce; console no longer framable via a shop param." },
  ...
  { module: "Routing", feature: "Shop-domain login form on the landing page", spec: "17", surface: "Public", design: "Yes", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "J-10", verifiedBy: "compliance", result: "PASS", defects: "D-30", notes: "Removed 2026-08-21 on an unverifiable req-2.3.1 reading; restored 2026-09-07 (Shopify own template ships it)." },
  ...
  { module: "Auth", feature: "TeamSession / AdminSession TTL & cleanup", spec: "18/19", surface: "Web/Admin", design: "N/A", logic: "Yes", tenancy: "Yes", planGate: "N/A", cases: "K-02,K-03,K-04", verifiedBy: "auth-sessions.test.ts", result: "PASS", defects: "D-23", notes: "Expired-session pruning added." },
  ...
  { module: "Auth", feature: "Login hardening (enumeration, lockout, CSRF)", spec: "18/19", surface: "Web/Admin", design: "N/A", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "K-07,K-08,K-16", verifiedBy: "auth-sessions.test.ts, admin-lockout-probe.ts", result: "PASS", defects: "", notes: "" },
  ...
  { module: "Auth", feature: "Cookie flags & iframe isolation", spec: "18", surface: "Web/Admin", design: "N/A", logic: "Yes", tenancy: "Yes", planGate: "N/A", cases: "K-13,K-14,K-15", verifiedBy: "auth-sessions.test.ts", result: "PASS", defects: "", notes: "HttpOnly/Secure/SameSite=Lax verified from real response headers." },
  ...
  // ── Admin ───────────────────────────────────────────────────────
  { module: "Admin", feature: "Operator auth & admin management", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "P-01,P-03", verifiedBy: "admin-lockout-probe.ts", result: "PASS", defects: "", notes: "Cannot remove yourself or the last admin." },
  { module: "Admin", feature: "Cross-tenant overview & usage reporting", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "Yes", planGate: "N/A", cases: "P-02,P-06", verifiedBy: "usage-check.ts", result: "PASS", defects: "D-24", notes: "Streamed calls counted exactly once." },
  { module: "Admin", feature: "Runtime settings (secrets, providers, flags)", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "P-05", verifiedBy: "admin-settings-check.ts", result: "PASS", defects: "", notes: "Secrets AES-GCM encrypted at rest; never sent to the browser." },
  { module: "Admin", feature: "AI model settings", spec: "19", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "N/A", planGate: "N/A", cases: "P-04,D-07", verifiedBy: "model-portability.test.ts", result: "PASS", defects: "", notes: "" },
  ...
  { module: "Logging", feature: "Operator log console", spec: "21", surface: "Admin", design: "Manual", logic: "Yes", tenancy: "Yes", planGate: "N/A", cases: "P-12", verifiedBy: "logs.test.ts", result: "PASS", defects: "", notes: "" },
  ...
  { module: "Compliance", feature: "App Store review checklist", spec: "17", surface: "—", design: "Manual", logic: "Yes", tenancy: "Yes", planGate: "N/A", cases: "O-07..O-11", verifiedBy: "APP-STORE-REVIEW.md", result: "PASS", defects: "", notes: "Re-executed 2026-08-21." },
...
const DEFECTS: Defect[] = [
  ...
  { id: "D-35", severity: "High", area: "Auth", file: "app/routes/web.logout.tsx", summary: "web.logout had no sameOrigin guard (admin.logout did), so a cross-site auto-submitting POST form was a working logout CSRF.", status: "Fixed", verifiedBy: "auth-sessions.test.ts" },
  ...
  { id: "D-12", severity: "Medium", area: "Plans", file: "app/lib/admin/admin-settings.server.ts", summary: "getStoredPlanConfig() swallowed parse failures into an empty object, so one corrupt row plus one operator edit silently discarded every other plan's overrides and the enforcement mode. Now logged loudly and the unparseable value is archived for recovery.", status: "Fixed", verifiedBy: "admin-check.ts" },
  ...
  { id: "D-29", severity: "Medium", area: "Security", file: "app/entry.server.tsx", summary: "addDocumentResponseHeaders sets frame-ancestors for the shop whenever a shop param is present and ran before the deny block, so appending one made the cross-tenant operator console framable. /admin is now in the deny branch; nosniff added globally; /app documents get no-store.", status: "Fixed", verifiedBy: "routing.test.ts (source)" },
  { id: "D-30", severity: "Medium", area: "Compliance", file: "app/routes/auth.login/", summary: "The template shop-domain login form was removed on 2026-08-21 citing App Store req 2.3.1. That citation was never verifiable (a shopify.dev search found no such rule then or on 2026-09-07) and Shopify own app template ships the form, so the landing page had no way in at all while the App Store listing was unpublished. REVERSED 2026-09-07: login() re-exported, the card restored on /, /auth/login now completes an install instead of dead-ending.", status: "No change needed", verifiedBy: "compliance re-audit" },
  ...
  { id: "D-37", severity: "Medium", area: "Routing", file: "app/lib/admin/admin-auth.server.ts", summary: "Admin deep links lost their query string on the auth bounce (a range param on the usage page was dropped).", status: "Fixed", verifiedBy: "routing.test.ts" },
