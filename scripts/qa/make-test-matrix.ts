...
const ROWS: Row[] = [
  ...
  { module: "Plans", feature: "Matrix matches published pricing", spec: "15", surface: "Server", design: "N/A", logic: "Yes", tenancy: "N/A", planGate: "Yes", cases: "B-01", verifiedBy: "platform-check.ts", result: "PASS", defects: "D-16", notes: "Reconciled 2026-08-21: manual_qas, policy_pages, crawl_pages, team_seats corrected." },
